...
exports.MaximumDepthOfBinaryTree = void 0;
...
class MaximumDepthOfBinaryTree {
     ...
     */
    static runTests() {
        TestHelper_1.TestHelper.printHeader('LeetCode 104. Maximum Depth of Binary Tree');
        ...
        for (const approach of approaches) {
            ...
            for (const testCase of testCases) {
                const root = DataStructures_1.DataStructureHelper.createBinaryTree(testCase.tree);
                const result = approach.method(root);
                TestHelper_1.TestHelper.runTest(testCase.name, testCase.expected, result);
            }
        }
        ...
        const largeTreeRoot = DataStructures_1.DataStructureHelper.createBinaryTree(largeTreeArray);
        for (const approach of approaches) {
            TestHelper_1.TestHelper.measureTime(() => approach.method(largeTreeRoot), `${approach.name} (1023 nodes)`);
        }
...
exports.MaximumDepthOfBinaryTree = MaximumDepthOfBinaryTree;
